...
from metaflow.api import foreach, step, join, Flow
...
class NewJoinFlow1(FlowSpec, metaclass=Flow):
    @step
    def generate_ints(self):
        self.ints = list(range(1, 16))
...
class NewJoinFlow2(FlowSpec, metaclass=Flow):
    @step
    def generate_ints(self):
        self.ints = list(range(1, 16))
...
class NewForeachSplitAnd(FlowSpec, metaclass=Flow):
    @step
    def start(self):
        self.items = [1,2,3,4]
