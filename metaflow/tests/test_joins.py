...
graph = [
    ...
    },
    {
        ...
        "type": "foreach",
        "in_funcs": ["start"],
        "out_funcs": ["test_prime"],
        "split_parents": [],
    },
    {
        "name": "test_prime",
        "type": "linear",
        "in_funcs": ["generate_ints"],
        "out_funcs": ["fizzbuzz"],
        "split_parents": ["generate_ints"],
    },
    {
        "name": "fizzbuzz",
        "type": "linear",
