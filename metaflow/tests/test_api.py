...
def test_api():
    ...
    # fmt: off
    expected = [
        {'name': 'start', 'type':  'start', 'in_funcs': [       ], 'out_funcs': [  'one'], 'func_lineno': 11, },
        {'name':   'one', 'type': 'linear', 'in_funcs': ['start'], 'out_funcs': [  'two'], 'func_lineno': 15, },
        {'name':   'two', 'type': 'linear', 'in_funcs': [  'one'], 'out_funcs': ['three'], 'func_lineno': 20, },
        {'name': 'three', 'type': 'linear', 'in_funcs': [  'two'], 'out_funcs': [  'end'], 'func_lineno': 25, },
        {'name':   'end', 'type':    'end', 'in_funcs': ['three'], 'out_funcs': [       ], 'func_lineno': 31, },
    ]
    # fmt: on
