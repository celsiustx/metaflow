...
def test_api():
    ...
    expected = [
        {'name': 'start', 'type': 'linear', 'in_funcs': [       ], 'out_funcs': [  'one'], 'func_lineno':  9, },
        {'name':   'one', 'type': 'linear', 'in_funcs': ['start'], 'out_funcs': [  'two'], 'func_lineno': 13, },
        {'name':   'two', 'type': 'linear', 'in_funcs': [  'one'], 'out_funcs': ['three'], 'func_lineno': 18, },
        {'name': 'three', 'type': 'linear', 'in_funcs': [  'two'], 'out_funcs': [  'end'], 'func_lineno': 23, },
        {'name':   'end', 'type':    'end', 'in_funcs': ['three'], 'out_funcs': [       ], 'func_lineno': 29, },
    ]
    ...
    assert data == { 'a': 111, 'b': 222, 'checked': True, }
